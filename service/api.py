...
class JPER(object):
    ...
    def validate(cls, account, notification, file_handle=None):
        ...
        try:
            ...
            app.logger.error("Request:{z} - Validate request from Account:{x} failed with error '{y}'".format(x=account.id, y=e, z=magic))
            raise ValidationException("Problem reading notification metadata: {x}".format(x=e))
        ...
        if file_handle is not None:
            ...
            try:
                ...
                app.logger.error("Request:{z} - Validate request from Account:{x} failed with error '{y}'".format(z=magic, x=account.id, y=e))
                raise ValidationException("Problem reading from the zip file: {x}".format(x=e))
            ...
            try:
                ...
                s.delete(validated_id)
                app.logger.error("Request:{z} - Validate request from Account:{x} failed with error '{y}'".format(z=magic, x=account.id, y=e))
                raise ValidationException("Problem extracting data from the zip file: {x}".format(x=e))
    ...
    def create_notification(cls, account, notification, file_handle=None):
        ...
        try:
            ...
            app.logger.error("Request:{z} - Create request from Account:{x} failed with error '{y}'".format(x=account.id, y=e, z=magic))
            raise ValidationException("Problem reading notification metadata: {x}".format(x=e))
        ...
        if file_handle is not None:
            ...
            try:
                ...
                app.logger.error("Request:{z} - Create request from Account:{x} failed with error '{y}'".format(z=magic, x=account.id, y=e))
                raise ValidationException("Problem reading from the zip file: {x}".format(x=e))
